...
>(({ className, ...props }, ref) => {
	return (
		<Separator
			...
			className={cn('my-4 w-auto bg-soft-purple', className)}
			{...props}
		/>
	);
});
 ...
 *
 * The `SidebarPanel` component is used to create a panel that slides in from the left from behind the sidebar.
 *
 * @component
 */
