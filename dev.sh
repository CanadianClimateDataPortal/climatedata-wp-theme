...
function _show_help {
  ...
  echo "    i18n-compile-main-site   Compile the .mo translation file for the main site pages."
  echo "    i18n-compile-react-apps  Compile the .mo translation file for the React maps and download apps."
  echo ""
  echo "  Other:"
