				...
				<div class="tab-drawer-content stick">
					<div class="tab-drawer-content-inner">
						<div class="control-tab-head d-flex justify-content-between align-items-center">
							...
							<button class="fw-query-reset btn btn-sm btn-gray-400 me-2 tab-drawer-close" style="display: none;"><?php _e ( 'Clear', 'cdc' ); ?></button>
						...
						<div class="control-tab-body query-container">
							...
							<?php
								...
								foreach ( array ( 'sector', 'var-type', 'variable-dataset' ) as $filter_tax ) {
