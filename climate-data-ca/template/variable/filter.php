<?php
  ...
  $filters = array (
    'coords' => array (
      'hidden' => true,
      'val' => '62.5325943454858,-98.525390625,4'
    ),
    'geo-select' => array (
      'hidden' => true,
      'val' => ''
  ...
  <div class="container-fluid">
    ...
    <form class="row w-100 align-items-center">
        ...
        while ( have_rows ( 'variable_filters' ) ) {
          ...
          switch ( get_row_layout() ) {
            ...
            case 'sector' :
              ...
              $sector_query = get_pages ( array (
                'post_type' => 'page',
                'child_of' => $sector_page_ID,
                'posts_per_page' => -1,
                'orderby' => 'menu_order',
                'order' => 'asc'
              ) );
      ...
      <?php
            ...
            case 'rcp' :
              ...
              $scenarios = array (
                ...
                array (
                  'value' => 'rcp26vs45',
                  'label' => 'RCP 2.6 vs RCP 4.5',
                  'compare' => true
                ),
                array (
                  'value' => 'rcp26vs85',
                  'label' => 'RCP 2.6 vs RCP 8.5',
                  'compare' => true
                ),
                array (
                  'value' => 'rcp45',
                ...
                array (
                  'value' => 'rcp45vs26',
                  'label' => 'RCP 4.5 vs RCP 2.6',
                  'compare' => true
                ),
                array (
                  'value' => 'rcp45vs85',
                  'label' => 'RCP 4.5 vs RCP 8.5',
                  'compare' => true
                ),
                array (
                  'value' => 'rcp85',
                ...
                array (
                  'value' => 'rcp85vs26',
                  'label' => 'RCP 8.5 vs RCP 2.6',
                  'compare' => true
                ),
                array (
                  'value' => 'rcp85vs45',
                  'label' => 'RCP 8.5 vs RCP 4.5',
                  'compare' => true
                )
              );
      ...
      <div class="filter-block col text-right col px-3">
        <a href="#" class="btn btn-outline-light rounded-pill page-tour-trigger all-caps" data-tour="page-tour">
          <span class="d-none d-xl-block"><?php _e ( 'New here? Take a tour!', 'cdc' ); ?></span>
          <span class="d-none d-lg-block d-xl-none"><?php _e ( 'Take a tour', 'cdc' ); ?></span>
          <span class="d-lg-none"><?php _e ( 'Tour', 'cdc' ); ?></span>
        </a>
      </div>
