<div class="map-container min-height-100">
	...
	<div id="help" class="map-page-overlay offcanvas offcanvas-top" tabindex="-1">
		<div class="offcanvas-body p-4 pe-6">
			<p class="mb-4"><?php _e ( 'Explore climate data using maps and charts. Click on the Data tab on the left for more data options, including selection of variable and emissions scenario. Select the Location tab or zoom in to view charts.', 'cdc' ); ?></p>
