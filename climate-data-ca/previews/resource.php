...
<div class="card h-100 bg-<?php echo $bg_colour; ?> bg-<?php echo $bg_style; ?> text-center text-<?php echo $text_colour; ?>">
  ...
  <a href="<?php echo $item['permalink']; ?>" class="btn rounded-pill btn-outline-secondary text-white overlay-toggle" data-overlay-content="video" data-overlay-opacity="0.8"><?php _e ( 'Explore', 'cdc' ); ?></a>
