		...
		<div class="row">
			...
			<div id="<?php echo $block_ID; ?>" class="<?php echo implode ( ' ', $block_class ); ?>">
				...
				<?php
							...
							if ( locate_template ( 'template/old-loop/blocks/' . get_row_layout() . '.php' ) != '' ) {

								include ( locate_template ( 'template/old-loop/blocks/' . get_row_layout() . '.php' ) );

							} else {

								echo 'block: ' . get_row_layout();
