/**
 * Custom script for the "Vertical allowance" variable
 */
    ...
    $(function () {
        ...
        var gridLayer_options = {
            ...
            vectorTileLayerStyles: {
                ...
                'allowancegrid': function (properties, zoom) {
                    return {
                        weight: 0.1,
                        color: '#89cff0',
                        opacity: 1,
        ...
        if ($('#mapRight').length) {
            ...
            gridLayerRight = L.vectorGrid.protobuf(
                hosturl + "/geoserver/gwc/service/tms/1.0.0/CDC:allowancegrid@EPSG%3A900913@pbf/{z}/{x}/{-y}.pbf",
                gridLayer_options
            ).on('click', function (e) {
                grid_click(e);
            ...
            wmsOptions = {
                ...
                'VERSION': '1.3.0',
                bounds: canadaBounds,
                layers: 'CDC:' + 'cmip6-allowance-ys-ssp126-p50-ann-30year'
            };
        ...
        function grid_hover(e) {
            ...
            gridHoverTimeout = setTimeout(function () {
                ...
                values_url = data_url + "/get-allowance-gridded-values/" +
                    e.latlng['lat'] + "/" + e.latlng['lng'] +
                    "?period=" + decade_value + '&dataset_name=cmip6';
        ...
        function grid_click(e) {
            ...
            genChart(e.latlng.lat, e.latlng.lng, 'allowance', 'ann');
                ...
                exporting: {
                    csv: {
                        columnHeaderFormatter: function (item, key) {
                            ...
                            if (key == 'low') {
                                return item.name.substring(0,8) + ' lower (5th percentile)';
                            }
                            if (key == 'y') {
                                return item.name.substring(0,8) + ' median (50th percentile)';
                            }
                            if (key == 'high') {
                                return item.name.substring(0,8) + ' upper (95th percentile)';
                            }
        ...
        var variableDownloadDataTypes = {
            ...
            'allowance': 'Vertical-Allowance_Change'
        };
        ...
        function setDataLayerForChartData(chartDataFormat, chartData) {
            ...
            var eventName = getGA4EventNameForVariableDownloadData(chartDataFormat, "allowance");
        ...
        function genChart(lat, lon, variable, month) {
            $(document).overlay('show', {
                href: base_href + 'variable/' + 'allowance' + '/',
                data: {
                    lat: lat,
                    lon: lon
                },
                content: 'allowance-location',
                position: 'right',
                callback: function (varDetails) {
                    ...
                    $.getJSON(
                        data_url + '/generate-charts/' + lat + '/' + lon + '/' + variable + '/' + month + '?dataset_name=cmip6',
                        function (data) {
        ...
        function generateLeftLegend() {
            ...
            var layer = 'cmip6-allowance-ys-' + rcp_value + '-ann-30year';
        ...
        function changeLayers() {
            ...
            singleLayerName = 'cmip6-allowance-ys-' + rcp_value + '-ann-30year';
            ...
            if (right_rcp_value !== 'disabled') {
                ...
                leftLayer.setParams({
                    ...
                    'VERSION': '1.3.0',
                    layers: 'CDC:' + 'cmip6-allowance-ys-' + rcp_value + '-ann-30year'
                });
                ...
                if (has_mapRight === true) {
                    rightLayer.setParams({
                        ...
                        'TIME': decade_value + '-01-00T00:00:00Z',
                        'VERSION': '1.3.0',
                        layers: 'CDC:' + 'cmip6-allowance-ys-' + right_rcp_value + '-ann-30year'
                    });
                }
