...
export const CANADA_BOUNDS: LatLngBounds = L.latLngBounds(L.latLng(41, -141.1), L.latLng(83.6, -49.9));
...
export const SEARCH_PLACEHOLDER: string = 'Zoom to a location, region, city, coordinates...';
