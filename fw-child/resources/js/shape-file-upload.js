 ...
 *             const json_data = custom_shape_file.get_selected_shape_json();
...
CustomShapeFile.prototype = {
     ...
     * Example:
     * <code>
     *     if (get_selected_shape_json.validate()) {
     *         const finch_request = {
     *             'inputs': [
     *                 {
     *                     'id': 'shape',
     *                     'data': my_custom_shape_file.get_selected_shape_json(),
     *                 },
     *                 {
     *                     'id': 'models',
     *                     'data': 'pcic12',
     ...
     * @returns {string}
     */
    get_selected_shape_json: function() {
...
MapShapesLayer.prototype = {
    ...
    add_topo_json: function (topo_json_data) {
        ...
        // TODO: temporarily commented because of a bug in the download_app where moving the map (manually or
        //      programmatically) triggers an error. Remove comment once the bug is fixed
