          ...
          $.getJSON(
              ...
              function (data) {
                  ...
                  for (var i = 0; i < data.length; i++) {
                      ...
                      data[i][0] = parseFloat((data[i][0] - k_to_c).toFixed(2));
                      data[i][1] = parseFloat((data[i][1] - k_to_c).toFixed(2));
                      data[i][2] = parseFloat((data[i][2] - k_to_c).toFixed(2));
  
                      data[i][3] = parseFloat((data[i][3] - k_to_c).toFixed(2));
                      data[i][4] = parseFloat((data[i][4] - k_to_c).toFixed(2));
                      data[i][5] = parseFloat((data[i][5] - k_to_c).toFixed(2));
  
                      data[i][6] = parseFloat((data[i][6] - k_to_c).toFixed(2));
                      data[i][7] = parseFloat((data[i][7] - k_to_c).toFixed(2));
                      data[i][8] = parseFloat((data[i][8] - k_to_c).toFixed(2));
                ...
                for (var year in data_obj) {
                  ...
                  for (var val in data_obj[year]) {
                    ...
                    if (data_obj[year][val] !== null) {
                      data_obj[year][val] = parseFloat((data_obj[year][val] - k_to_c).toFixed(2));
                    }
