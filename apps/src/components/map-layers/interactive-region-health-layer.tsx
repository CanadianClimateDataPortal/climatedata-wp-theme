...
const InteractiveRegionHealthLayer: React.FC = () => {
	...
	useEffect(() => {
		...
		const tileLayerUrl = `${GEOSERVER_BASE_URL}/geoserver/gwc/service/tms/1.0.0/CDC:health/{z}/{x}/{-y}.pbf`;
...
export default InteractiveRegionHealthLayer;
