<form action="./" method="get" name="station-download-form" id="station-download-form">
  ...
  <div class="form-layout-row row">
    ...
    <div class="form-input form-text col-3">
      <label for="limit" class="form-label"><?php _e ( 'Limit', 'cdc' ); ?></label>
      <input type="number" class="form-control form-control-lg validate" name="limit" id="limit" value="150000" min="0" placeholder="<?php _e ( 'Maximum number of rows e.g. 150000', 'cdc' ); ?>" data-lpignore="true">
    </div>
    
    <div class="form-input form-text col-3 offset-1">
      <label for="offset" class="form-label"><?php _e ( 'Offset', 'cdc' ); ?></label>
      <input type="number" class="form-control form-control-lg validate" name="offset" id="offset" value="0" min="0" placeholder="<?php _e ( 'Use this value to offset large blocks of data', 'cdc' ); ?>" data-lpignore="true">
    </div>
    
    <div class="form-input form-radio col-7 offset-3">
