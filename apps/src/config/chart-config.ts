...
export const getChartDataOptions = (
	...
	ssp585lowConf: {
		name: __('SSP5-8.5 High ice sheet loss A'),
		color: '#8A2BE2',
		type: 'line',
	},
	ssp585highEnd: {
		name: __('SSP5-8.5 High ice sheet loss B'),
		color: '#FF1493',
		type: 'line',
	},
	uplift: {
		name: __('Vertical Land Motion'),
		color: '#808080',
		type: 'line',
	},
	rcp26_median: {
		...
		switch (version) {
			...
			case 'cmip6':
				return [
					...
					{
						custom: { key: 'ssp585lowConf' },
						name: chartDataOptions['ssp585lowConf'].name,
						type: chartDataOptions['ssp585lowConf'].type,
						data: sortByTimestamp(data.ssp585lowConf),
						color: chartDataOptions['ssp585lowConf'].color,
						lineWidth: 2,
						showInNavigator: true,
						visible: false,
					} as SeriesLineOptions,
					{
						custom: { key: 'ssp585highEnd' },
						name: chartDataOptions['ssp585highEnd'].name,
						type: chartDataOptions['ssp585highEnd'].type,
						data: sortByTimestamp(data.ssp585highEnd),
						color: chartDataOptions['ssp585highEnd'].color,
						lineWidth: 2,
						showInNavigator: true,
						visible: false,
					} as SeriesLineOptions,
					{
						custom: { key: 'uplift' },
						name: chartDataOptions['uplift'].name,
						type: chartDataOptions['uplift'].type,
						data: sortByTimestamp(data.uplift),
						color: chartDataOptions['uplift'].color,
						lineWidth: 2,
						showInNavigator: true,
						visible: false,
					} as SeriesLineOptions,
