  ...
  <section id="analyze-projections" class="page-section bg-white tab">
      ...
      <div id="analyze-form" class="analyze-form col-3">
        ...
        <form id="analyze-form-inputs" class="analyze-form-inputs">
            ...
            <input class="add-to-object" type="hidden" name="center" id="center" value="62.51;-98.57">
            ...
            <input type="hidden" id="threshold" value="">
          ...
          <div id="analyze-steps" class="analyze-steps">
                ...
                <div class="accordion-content select-locations" data-step="2">
                  <div class="accordion-content-inner">
                    ...
                    <div class="input-row form-check">
                        <div class="input-item">
                          <input class="form-check-input add-to-object" type="radio" name="analyze-location" id="analyze-location-census" value="census">
                    ...
                    <div class="input-row form-check">
                        <div class="input-item">
                          <input class="form-check-input add-to-object" type="radio" name="analyze-location" id="analyze-location-health" value="health">
