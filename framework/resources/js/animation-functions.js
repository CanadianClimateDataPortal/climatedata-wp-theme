(function($) {
	$(function() {
		...
		console.log('begin animation-functions.js')
		
		$('.fw-animation').each(function() {
			...
			new_anim.lottie = new_anim.settings.container.getLottie()
			
			animations[new_anim.id] = new_anim
			
		})
		
		inView('.fw-animation:not(.in-carousel)')
			.on('enter', function(element) {
			
				let this_id = $(element).attr('id')
...
*/
		...
		console.log('end animation-functions.js')
