 ...
 *
 * Realistic `LocationModal` markup used across this namespace's sender-side
 * tests: the popup content `getLocationModalInnerHTML` scrapes and
 * `createPrepareRasterPostHttpPayload` carries in its payload.
 *
