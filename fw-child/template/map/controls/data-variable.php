				...
				<div id="var-select-query" class="variable-grid"
					data-args='{
						...
						if ($GLOBALS['fw']['current_lang_code'] == 'fr') {
							echo '"orderby":"meta_value",';
							echo '"meta_key": "title_fr",';
						} else {
							echo '"orderby":"title",';
						}
						?>
				...
				>
					...
					<div id="" class="query-container d-flex align-items-center border-bottom px-1">
						...
						<div class="d-flex justify-content-end ms-auto me-2">
							<h6 class="fw-query-reset mb-0 all-caps" role="button" style="display: none;"><?php _e ( 'Clear', 'cdc' ); ?></h6>
						</div>
					</div>
					...
					<div id="" class="query-container p-2">
						<div class="fw-query-pagination d-flex justify-content-between align-items-center">
							...
							<div class="fw-query-pagination-btn next btn btn-secondary btn-sm"><?php _e ( 'Next', 'cdc' ); ?></div>
						</div>
					</div>
				</div>
