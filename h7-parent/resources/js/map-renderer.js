...
*/
    ...
    generate_legend: function(fn_options) {
      ...
      $.getJSON(plugin_settings.hosturl + '/geoserver/wms?service=WMS&version=1.1.0&request=GetLegendGraphic&layer=CDC:' + plugin_settings.maps.main.query.variable + '-ys-' + plugin_settings.maps.main.query.rcp + '-p50-ann-30year' + '&format=application/json')
        .then(function (data) {
      ...
      if (plugin_settings.compare == true) {
        ...
        $.getJSON(plugin_settings.hosturl + '/geoserver/wms?service=WMS&version=1.1.0&request=GetLegendGraphic&layer=CDC:' + plugin_settings.maps.right.query.variable + '-ys-' + plugin_settings.maps.right.query.rcp + '-p50-ann-30year' + '&format=application/json')
          .then(function (data) {
