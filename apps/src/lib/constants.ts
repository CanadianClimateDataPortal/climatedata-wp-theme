...
export const DEFAULT_COLOUR_SCHEMES = {
	temp_seq: ["#FEFECB", "#FDF6B5", "#FBED9E", "#F9E286", "#F5D470", "#F1C35F", "#EEB257", "#EAA253", "#E79352", "#E38450", "#DE744F", "#D3644D", "#C25449", "#AC4944", "#95413D", "#7E3B34", "#68342A", "#522D1F", "#3E2616", "#2B200D", "#191900"],
	prec_seq: ["#FFFFE5", "#EEF6DD", "#DDEDD6", "#CCE4CF", "#BBDCC8", "#AAD3C1", "#9ACBBA", "#89C2B2", "#78B9AB", "#67B1A4", "#56A89D", "#459F96", "#34968E", "#2E8B83", "#278077", "#21746B", "#1A695F", "#135E53", "#0D5247", "#06473B", "#003C30"],
	misc_seq_3: ["#001959", "#07265B", "#0D335D", "#11415F", "#184E61", "#225B5F", "#32665A", "#446F51", "#577547", "#6A7B3C", "#7F8133", "#97872D", "#B28D32", "#CC9241", "#E39757", "#F39E71", "#FBA68D", "#FDAFA7", "#FDB8C2", "#FCC2DD", "#FACCFA"],
	temp_div: ["#053061", "#144879", "#246192", "#337AAA", "#4393C3", "#61A3CB", "#7FB5D4", "#9EC6DE", "#BCD6E6", "#DAE8F0", "#F8F8F8", "#F3DFDC", "#EDC5BF", "#E7ACA3", "#E19286", "#DB7969", "#D6604C", "#BA4841", "#9E3036", "#82182A", "#67001F"],
	prec_div: ["#543005", "#6E440F", "#895819", "#A46C23", "#BF812C", "#C8944F", "#D2A971", "#DCBD93", "#E5D1B4", "#EFE4D7", "#F8F8F7", "#D8E8E7", "#B7D8D5", "#97C8C3", "#76B7B2", "#55A7A0", "#35978F", "#278077", "#1A695F", "#0D5247", "#003C30"],
	misc_div: ["#081D58", "#1F2F88", "#234DA0", "#1F72B1", "#2498C0", "#41B6C3", "#73C8BC", "#AADEB6", "#D6EFB2", "#F0F9B9", "#FEFED1", "#FFF0A9", "#FEE187", "#FEC965", "#FDAA48", "#FD8D3C", "#FC5A2D", "#ED2F21", "#D30F1F", "#B00026", "#800026"],
}
