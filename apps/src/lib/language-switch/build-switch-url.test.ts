...
describe('resolveOriginForLocale (locale-addressed origin resolution)', () => {
	...
	test.each([
		['dev-en.climatedata.ca', 'fr', 'https://dev-fr.climatedata.ca'],
		['dev-fr.climatedata.ca', 'en', 'https://dev-en.climatedata.ca'],
		['uat.donneesclimatiques.ca', 'en', 'https://uat.climatedata.ca'],
		['uat.climatedata.ca', 'fr', 'https://uat.donneesclimatiques.ca'],
		['qa.donneesclimatiques.ca', 'en', 'https://qa.climatedata.ca'],
		['qa.climatedata.ca', 'fr', 'https://qa.donneesclimatiques.ca'],
		['preprod.donneesclimatiques.ca', 'en', 'https://preprod.climatedata.ca'],
		['preprod.climatedata.ca', 'fr', 'https://preprod.donneesclimatiques.ca'],
		['climatedata.ca', 'fr', 'https://donneesclimatiques.ca'],
		['donneesclimatiques.ca', 'en', 'https://climatedata.ca'],
	] as const)(
		'%s + locale %s → %s (sibling host)',
		(hostname, targetLocale, expected) => {
			expect(resolveOriginForLocale(hostname, 'https:', targetLocale)).toBe(
				expected,
			);
		},
	);
	...
	test.each([
		['dev-en.climatedata.ca', 'en', 'https://dev-en.climatedata.ca'],
		['dev-fr.climatedata.ca', 'fr', 'https://dev-fr.climatedata.ca'],
		['uat.climatedata.ca', 'en', 'https://uat.climatedata.ca'],
		['climatedata.ca', 'en', 'https://climatedata.ca'],
		['donneesclimatiques.ca', 'fr', 'https://donneesclimatiques.ca'],
	] as const)(
		'%s + locale %s → %s (self)',
		(hostname, targetLocale, expected) => {
			expect(resolveOriginForLocale(hostname, 'https:', targetLocale)).toBe(
	...
	test.each([
		['localhost', 'en', 'https://localhost'],
		['localhost', 'fr', 'https://localhost'],
	] as const)(
