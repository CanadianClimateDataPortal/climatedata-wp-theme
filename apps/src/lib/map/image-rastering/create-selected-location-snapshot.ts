 ...
 * selected.
 * `createFetchRequestInitToRaster` then sends `{}` as the body.
 ...
 */
export const createSelectedLocationSnapshot = (
	latlng: L.LatLngLiteral,
): SelectedLocationSnapshot | undefined => {
	const markerLatLon: SelectedLocationSnapshot['markerLatLon'] | null = latlng
