...
function fw_enqueue_scripts() {
	...
	wp_register_script ( 'global', $js_dir . 'global-functions.js', array ( 'jquery' ), null, true );
	...
	wp_register_script ( 'builder', $js_dir . 'builder.js', array ( 'jquery', 'aos', 'animation', 'bootstrap-js' ), null, true );
